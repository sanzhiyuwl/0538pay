...
import { notices as source, type Notice } from '@/lib/mock/notifications'
import { ref } from 'vue'

defineProps<{ open: boolean }>()
const emit = defineEmits<{ close: [] }>()

const list = ref<Notice[]>([...source])
  ...
  >
    ...
    >
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        >
          <div
            :class="['flex size-9 shrink-0 items-center justify-center rounded-lg', tintMap[n.type]]"
          >
