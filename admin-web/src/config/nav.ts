...
export const navMenu: NavNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: '邀请码管理', to: '/invite-codes' },
      { title: '资金明细', to: '/records' },
      { title: '支付统计', to: '/merchant-stats' },
      { title: '支付用户统计', to: '/buyer-stats' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: '企业微信', to: '/wework' },
      { title: '微信客服支付', to: '/wxkf-settings' },
      { title: '获取用户标识', to: '/gettoken' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: '快捷登录', to: '/oauth-settings' },
      { title: '消息提醒', to: '/notice-settings' },
      { title: '实名认证', to: '/cert-settings' },
      { title: '首页模板', to: '/template-settings' },
      { title: '邮箱短信', to: '/mail-settings' },
      { title: '计划任务', to: '/cron-settings' },
      { title: '网站公告', to: '/announcements' },
      { title: '登录日志', to: '/logs' },
      { title: '数据清理', to: '/clean' },
      { title: '其余设置', to: '/other-settings' },
    ],
  },
]
